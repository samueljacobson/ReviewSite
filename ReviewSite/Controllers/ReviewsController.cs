...
namespace ReviewSite.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewID,ReviewTitle,ReviewDate,ReviewContent,ReviewerName,CategoryID")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewID,ReviewTitle,ReviewDate,ReviewContent,ReviewerName,CategoryID")] Review review)
        {
            if (ModelState.IsValid)
            {
